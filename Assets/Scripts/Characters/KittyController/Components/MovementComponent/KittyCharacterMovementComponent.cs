...
{
    public class KittyCharacterMovementComponent : ICharacterMovementComponent, ITickable
    {
        ...
        public void Move()
        {
            ...
            float targetSpeed = CharacterInputComponent.SprintAction ? _playerCharacterParametersData.SprintSpeed : _playerCharacterParametersData.MoveSpeed;
            ...
            float currentHorizontalSpeed = new Vector3( characterPhysicsDataStorage.CharacterController.velocity.x, 0.0f,  characterPhysicsDataStorage.CharacterController.velocity.z).magnitude;
        ...
        {
            Vector3 inputDirection = new Vector3(CharacterInputComponent.MoveAction.x, 0.0f, CharacterInputComponent.MoveAction.y).normalized;
            ...
            if (CharacterInputComponent.MoveAction != Vector2.zero)
            {
                ...
                float rotation = Mathf.SmoothDampAngle(characterTransform.eulerAngles.y, targetRotation, ref rotationVelocity,
        ...
        private void CameraRotation()
        {
            ...
            if (CharacterInputComponent.LookAction.sqrMagnitude >= THRESHOLD && !_playerCharacterParametersData.LockCameraPosition)
            {
                ...
                cinemachineTargetYaw += CharacterInputComponent.LookAction.x;// * deltaTimeMultiplier;
                cinemachineTargetPitch += CharacterInputComponent.LookAction.y;// * deltaTimeMultiplier;
            }
