...
namespace Arenar.Character
{
    ...
    public class CharacterAnimatorDataStorage
    {
        ...
        [SerializeField] private AnimationReactionsTriggerController _animationReactionsTriggerController;
        ...
        [SerializeField] private string reloadAnimationTriggerName = "Reload";

        [Space(10), Header("Parameters")]
        [SerializeField] private bool isReloadByAnimation = false;
